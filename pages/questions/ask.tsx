        ...
        <div className='mx-5' >
            ...
            <div className='max-w-[700px]'>
                <div className={`${isUnderstood ? 'hidden' : 'inline-block'}`}>
                    <div className='bg-blue-50 py-5 px-10 space-y-2'>
                    ...
                    <button className='bg-blue-500 hover:bg-blue-300 py-1 px-3 text-white rounded-sm mt-5'
                        onClick={() => setIsUnderstood(true)}>I understand</button>
                </div>
                {/* Step 1 title */}
                <div className={`${isUnderstood ? 'inline-block' : 'hidden'} space-y-8`}>
                    <div className='flex flex-col bg-gray-100 py-5 px-10 space-y-2 rounded-md'>
